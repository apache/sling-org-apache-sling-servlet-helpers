 ...
 */
@ConsumerType
public class MockSlingJakartaHttpServletRequest extends SlingAdaptable implements SlingJakartaHttpServletRequest {
    ...
    private MockJakartaRequestDispatcherFactory requestDispatcherFactory;
    ...
    protected MockJakartaHttpSession newMockJakartaHttpSession() {
    ...
    public HttpSession getSession(boolean create) {
        if (this.session == null && create) {
            this.session = newMockJakartaHttpSession();
        }
        return this.session;
    }
