 ...
 */
@ConsumerType
public class MockJakartaHttpSession implements HttpSession {
    ...
    public MockJakartaHttpSession() {
        this.servletContext = newMockJakartaServletContext();
    }

    protected MockJakartaServletContext newMockJakartaServletContext() {
