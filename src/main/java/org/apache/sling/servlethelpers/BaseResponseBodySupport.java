 ...
 */
public abstract class BaseResponseBodySupport<T extends OutputStream> {

    protected ByteArrayOutputStream outputStream;
    protected T servletOutputStream;
    protected PrintWriter printWriter;

    protected BaseResponseBodySupport() {
        reset();
    }
    ...
    public abstract T getOutputStream();
